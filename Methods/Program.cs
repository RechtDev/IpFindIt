    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            while (BackToMenu)
            {
                ...
                Console.WriteLine("1)Find IP Addresse \n" +
                ...
                while (repeat)
                {
                    switch (Int32.Parse(menuChoice))
                    {
                        case 1:
                            Console.Clear();
                            Messages.PromptMessage("Okay please enter the IP Addresse you wish you look up.", ConsoleColor.Green);
                            Messages.PromptMessage("IP Address: ", ConsoleColor.Green);
